    ...
    <main>
      ...
      <section className='hidden lg:block'>
        ...
        <div className='fixed bottom-0 left-10 flex flex-col text-xl'>
          ...
          <a className='relative bottom-24 hover:text-blue_30 dark:text-white dark:hover:text-blue_60 hover:scale-125' href="/"><i className="uil uil-linkedin-alt"></i></a>
          <a className='relative bottom-16 hover:text-blue_30 dark:text-white dark:hover:text-blue_60 hover:scale-125' href="/"><i className="uil uil-github-alt"></i></a>
          <a className='relative bottom-8 hover:text-blue_30 dark:text-white dark:hover:text-blue_60 hover:scale-125' href="/"><i className="uil uil-twitter-alt"></i></a>
