...
export default function Navbar({ darkTheme, setDarkTheme }) {
  ...
  return (
    <header className='dark:bg-blue_10 dark:text-white duration-500'>
      <nav className='flex items-center justify-between px-7 py-7 md:py-0 lg:px-14 w-full'>
        <div>
          {/* logo */}
          <a href="/">
        ...
        <div className='flex items-center justify-between'>
          ...
          <ul className='fixed top-0 -right-2/3 peer-checked:right-0 duration-500 pt-20 md:pt-0 pb-32 md:pb-0 bg-blue_20 w-2/3 md:w-full h-full md:bg-white dark:bg-blue_10 md:static font-semibold flex flex-col md:flex-row items-center justify-around md:justify-center md:text-sm lg:text-base z-30'>
            {/* menu */}
