        ...
        <div className='grid col-span-12 md:grid-cols-12 py-10'>
          ...
          <div className='col-span-12 md:col-span-7 font-medium xl:text-lg text-blue_30 dark:text-blue_90 order-2'>
            ...
            <div className='pb-5'>
              ...
              <div className='flex'>
                <ul className='mr-10'>
                  <li><i className="uil uil-angle-double-right text-blue_10 dark:text-blue_50"></i> Javascript (ES6+) </li>
                  <li><i className="uil uil-angle-double-right text-blue_10 dark:text-blue_50"></i> React</li>
                  <li><i className="uil uil-angle-double-right text-blue_10 dark:text-blue_50"></i> Git</li>
                </ul>
                <ul className=''>
                  <li><i className="uil uil-angle-double-right text-blue_10 dark:text-blue_50"></i> Tailwind</li>
                  <li><i className="uil uil-angle-double-right text-blue_10 dark:text-blue_50"></i> Bootstrap</li>
                  <li><i className="uil uil-angle-double-right text-blue_10 dark:text-blue_50"></i> Figma</li>
                </ul>
              </div>
            </div>
